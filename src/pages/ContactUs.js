...
//               <button
//                 type="submit"
//                 className="w-full md:w-auto px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 ease-in-out"
//               >
//                 Send Message
//               </button>
//             </form>
...
//           {/* Contact Information */}
//           <div className="bg-gradient-to-b from-gray-900 to-black text-white rounded-2xl shadow-lg p-8">
//             <div className="flex items-center space-x-2 mb-8">
//               <Building2 size={32} className="text-blue-500" />
//               <h2 className="text-2xl font-bold">Gyan Group</h2>
//             </div>
