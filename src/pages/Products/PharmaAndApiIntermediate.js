...
function PharmaAndApiIntermediate() {
  return (
    <>
      <BreadCrumb
      ...
      <div className="py-12 md:py-14 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeLeft>
            <h1 className=" text-[26px] md:text-3xl lg:text-[32px] px-4 font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800 mb-5 mt-9">
                  ...
                  <div className="relative aspect-square w-full mb-4 rounded-lg overflow-hidden bg-gray-50 border-slate-200 border-[2px]">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                      <NavLink
                        ...
                        className="w-full inline-flex items-center justify-center px-4 py-2 bg-white/90 backdrop-blur-sm text-gray-900 rounded-md hover:text-white hover:bg-gradient-to-r from-blue-600 to-blue-800 transition-colors duration-200"
                        state={{ product }}
                      >
...
export default PharmaAndApiIntermediate;
